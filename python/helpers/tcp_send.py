...
def prepare_data_to_send(alpha_vec, beta_vec):
    """
    ...
    # TODO - add lower command
    # TODO - add lift command

    print(commands_vector)
...
# #send = [0, 90, 5, 95, 10, 100, 15, 105, 20, 110, 25, 115, 30, 120,
#         35, 125, 40, 130, 45, 135, 50, 140, 55, 145, 60, 150, 65, 155,
#         70, 160, 75, 165, 80, 170, 85, 175]
DE_boto = tcp_connection()
if(DE_boto.connected):
    send = [DE_boto.lift_code,DE_boto.lift_code, 20,180-20]
